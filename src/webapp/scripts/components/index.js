...
import externalComponentMarkup from '@scripts/components/external-component-markup/external-component-markup';
...
export default angular.module('pitsby-components', [])
  ...
  .component('pExternalComponentMarkup', externalComponentMarkup)
